...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <style>
        ...
        /* El hover solo para las tarjetas del menú principal, no para el modal */
        .card-menu:hover {
    ...
    <div class="container pb-5">
        ...
        <%-- Panel principal para evitar recargas completas --%>
                    ...
                    <div class="col-md-5 mb-4">
                        <div class="card card-custom card-menu h-100">
                            ...
                            <div class="card-body text-center p-5">
                                ...
                                <%-- Botón registrar compra con evento Click --%>
    ...
    <%-- 🟢 MODAL DE REPOSICIÓN DE STOCK (COMPRA) --%>
